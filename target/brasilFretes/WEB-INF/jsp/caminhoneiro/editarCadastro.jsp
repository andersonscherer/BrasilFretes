            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<c:url value='/editarCadastro'/>"><i class="fa fa-user fa-fw"></i>Editar dados Pessoais</a>
                        </li>
                            ...
                            <form class="form-horizontal">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input id="textinput" name="caminhoneiro.nome" placeholder="Placa do Veículo" class="form-control input-md" disabled="disabled" required="" type="text">
                                        </div>
                                    </div>
