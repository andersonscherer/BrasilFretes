...
<body>
						...
						<div class="table-responsive">
							<form class="form-horizontal"
								...
								<div class="form-group">
									...
									<div class="col-md-2">
										<input id="peso" name="frete.peso" placeholder="000.00KG"
											class="form-control input-md" required="" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="textinput">Valor
										do Frete (R$)</label>
									<div class="col-md-2">
										<input id="valor" name="frete.valor" placeholder="0.00"
											class="form-control input-md" required="" type="text">
									</div>
								</div>
	...
	<script
		src="<%=request.getContextPath()%>/resources/js/jquery.maskMoney.min.js"></script>
