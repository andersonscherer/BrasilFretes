...
<html>
	<head>
		...
		<title>BrasilFretes - Login Agência</title>
	</head>
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-md-offset-4 text-center logo-margin ">
				<a class="light white navbar-brand" href="<c:url value='/'/>">
				<img src="<%=request.getContextPath()%>/resources/imagens/favicons/logo.png" 
				data-active-url="<%=request.getContextPath()%>/resources/imagens/favicons/logo.png" alt=""></a>
			</div>
			<div class="col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Agência. Faça login para entrar</h3>
					</div>
					<div class="panel-body">
						...
						<form role="form" action="${linkTo[IndexController].confereAgencia}" method="post">
							<fieldset>
								...
								<button type="submit" class="btn btn-lg btn-primary btn-block espaco-btn">Entrar</button>
							</fieldset>
						</form>
					</div>
				</div>
